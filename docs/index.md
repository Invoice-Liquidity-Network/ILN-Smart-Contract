...
| [Decentralization Roadmap](decentralization-roadmap.md) | Quantitative trigger criteria, prerequisite safety gates, and test validation for sunsetting admin veto power. |
