...
pub enum DataKey {
    ...
    BalanceCap,
    /// Proposed new risk multiplier numerator awaiting timelock expiry.
    PendingRiskMultiplierNumerator,
    /// Proposed new risk multiplier denominator awaiting timelock expiry.
    PendingRiskMultiplierDenominator,
    /// Ledger timestamp at which the pending risk multiplier change becomes executable.
    RiskMultiplierEta,
}
